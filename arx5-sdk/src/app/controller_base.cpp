      ...
      robot_config_(robot_config), controller_config_(controller_config)
{
    ...
    std::cout << "==== Arx5Solver init params ====" << std::endl;
    std::cout << "urdf_path: " << robot_config_.urdf_path << std::endl;
    std::cout << "joint_dof: " << robot_config_.joint_dof << std::endl;
    std::cout << "joint_pos_min size: " << robot_config_.joint_pos_min.size() << std::endl;
    std::cout << "joint_pos_max size: " << robot_config_.joint_pos_max.size() << std::endl;
    std::cout << "base_link: " << robot_config_.base_link_name << std::endl;
    std::cout << "eef_link: " << robot_config_.eef_link_name << std::endl;
    std::cout << "gravity: " << robot_config_.gravity_vector.transpose() << std::endl;
    std::cout << "================================" << std::endl;
